package br.com.wedocode.shopping.view.react.stub;
...
public class Activator
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        try {
            ...
            this.scheduleNextApplicationCollector();
    ...
    private void scheduleNextApplicationCollector() {
        var timeSpanInSec = ApplicationReactImpl.DEFAULT_TIME_SPAN
                .plusSeconds(10)
                .toSeconds();

        var task = new MutableObject<Runnable>();
        task.setValue(() -> {
            ApplicationReactImpl.removeExpireds();
            scheduledExecutorService.schedule(task.getValue(), timeSpanInSec, TimeUnit.SECONDS);
        });
