...
import br.com.wedocode.framework.commons.security.RSA;
...
public enum AppSecurity {
    ...
    AppSecurity() {
        ...
        { // Cipher RSA
            String sPublicKey, sPublicExponent;
    ...
    private void prepareSignKeys(String publicKeyInBase64, String privateKeyInbase64) throws Exception {
    ...
    public boolean isThisSignatureValid(byte[] contentBytes, byte[] signature) {
        try {
            var verify = Signature.getInstance("SHA256withRSA");
