...
public enum Base62 {
    ...
    private Base62(final byte[] alphabet, byte[] lookup) {
    ...
    /**
     * Uses the elements of a byte array as indices to a dictionary and returns the corresponding values in form of a
     * byte array.
     */
    ...
    private static class CharacterSets {
         ...
         */
        private static byte[] createLookupTable(byte[] alphabet) {
